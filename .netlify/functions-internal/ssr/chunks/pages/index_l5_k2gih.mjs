...
const $$file$2 = "/Users/carles/Documents/Code/Proyectos/unboxthem-astro-contentful/src/pages/posts/index.astro";
const $$url$2 = "/posts";
...
const $$EarlyAccessHeader = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<header class="px-4 shadow-black text-white"> <nav class="flex items-center justify-between"> <h2><a href="/">Unboxthem</a></h2> <div class="internal-links"> <a class="py-4 px-2 no-underline border-b-4 border-b-[var(--secondary-100)] active:border-b-white" href="/">Home</a> <a class="py-4 px-2 no-underline" href="/send">Send your story</a> </div> <div class="social-links flex"> <a class="py-4 px-2" href="https://twitter.com/astrodotbuild" target="_blank"> <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-brand-x"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M4 4l11.733 16h4.267l-11.733 -16z"></path><path d="M4 20l6.768 -6.768m2.46 -2.46l6.772 -6.772"></path></svg> </a> <a class="py-4 px-2" href=""> <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-search"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 10m-7 0a7 7 0 1 0 14 0a7 7 0 1 0 -14 0"></path><path d="M21 21l-6 -6"></path></svg> </a> </div> </nav> </header>`;
...
const $$EarlyAccessLayout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { title } = Astro2.props;
  return renderTemplate`<html lang="en"> <head><meta charset="UTF-8"><meta name="description" content="Astro description"><meta name="viewport" content="width=device-width"><link rel="icon" type="image/svg+xml" href="/favicon.svg"><meta name="generator"${addAttribute(Astro2.generator, "content")}><title>${title}</title>${renderComponent($$result, "ViewTransitions", $$ViewTransitions, {})}${renderHead()}</head> <body> ${renderComponent($$result, "EarlyAccessHeader", $$EarlyAccessHeader, {})} ${renderSlot($$result, $$slots["default"])}  </body> </html>`;
...
const $$Index$1 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index$1;
  return renderTemplate`${renderComponent($$result, "EarlyAccessLayout", $$EarlyAccessLayout, { "title": "Send your story", "data-astro-cid-snyv6bvl": true }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<section class="flex justify-center items-center min-h-screen" data-astro-cid-snyv6bvl> <div class="container" data-astro-cid-snyv6bvl> <div class="call-to-action mt-24 mb-32 flex flex-col items-center gap-12 rounded-xl p-12 md:p-24" data-astro-cid-snyv6bvl> <h2 class="text-center text-3xl md:text-5xl" data-astro-cid-snyv6bvl>
Share your story with us. Let your voice be heard
</h2> <a href="https://github.com/markteekman/accessible-astro-starter" class="text-center text-lg" data-astro-cid-snyv6bvl>
Send email</a> </div> </div> </section> ` })} `;
}, "/Users/carles/Documents/Code/Proyectos/unboxthem-astro-contentful/src/pages/send/index.astro", void 0);

const $$file$1 = "/Users/carles/Documents/Code/Proyectos/unboxthem-astro-contentful/src/pages/send/index.astro";
const $$url$1 = "/send";
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  return renderTemplate`<!-- <Layout title="Welcome to Unboxthem."> -->${renderComponent($$result, "EarlyAccessLayout", $$EarlyAccessLayout, { "title": "Welcome to Unboxthem.", "data-astro-cid-j7pv25f6": true }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main data-astro-cid-j7pv25f6> ${renderComponent($$result2, "HeroLaunch", $$HeroLaunch, { "data-astro-cid-j7pv25f6": true })} </main> ` })} <!-- </Layout> --> `;
